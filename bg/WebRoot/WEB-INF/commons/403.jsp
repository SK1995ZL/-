...
<head>
	...
	<style type="text/css">
		...
		#header { position: relative; width: 100%; background:#337DBC; height:60px !important;border-bottom:2px solid #7083e1;}
		#header h1 { margin:0 !important;padding:0 !important;text-indent:-2000em;width:214px;height:60px;}
		#header #logo {position:absolute;top:15; left:10px; right:0;background:#337DBC; font-family: Tahoma, Arial, Helvetica, sans-serif; font-weight: 500; font-size:22px; color:#FFFFFF;}
		...
		#bottom { position:absolute; bottom:0; width: 100%; background: #337DBC; height:38px !important;}
	...
	<body>
		<div id="header">
			<div id="logo"><a href="./login" target="_self" style="color:#FFFFFF; text-decoration: none;">百宁医学软件</a></div>
		</div>
		<div class="aligncenter">
			<div id="centered">
				<div id="content">
					<h2>Error 403: 没有权限</h2>
					<p>请求页面没有权限,可能因为以下原因所致:</p>
					<ul>
						<li>页面或文件过期, 重命名, 移除, 或不存在.</li>
						<li>输入地址错误, 例如: http://www.example.com/<b>pgae</b>.html 而您输入 http://www.example.com/<b>page</b>.html</li>
					</ul>
		...
		<div id="copyright"><a href="./login" target="_blank">Copyright &#169; 2008-2012&nbsp;&nbsp;百宁<br/> All Rights Reserved.</a></div>
		<div id="bottom">
			<div id="bottom_text">中投远恒(北京)科技有限公司&nbsp;&nbsp;版权所有 </div>
		</div>
	</body>
</html>