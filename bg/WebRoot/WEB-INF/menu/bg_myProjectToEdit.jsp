...
<html>
  ...
  <body>
	<div class="title_h1">报馆项目编辑</div>
	 	<form method="POST" id="editObjectForm" action="./menu!myProjectEdit.ht">
			<table id="" cellpadding="0" cellspacing="0" class="tbB">
				...
				<tr>
					<th>项目名称</th>
					<td colspan="3"><input type="text" name="name" id="edit_name" class="easyui-textbox" style="width:100%;height:auto;" data-options="required:true,validType:['projectName','minLength[5]']"></td>
				</tr>
				<tr>
					<th>报馆开始开始时间</th>
					<td>
						<input type="text" name="officeStart" id="edit_officeStart" class="easyui-datetimebox" required style="width:100%;height:auto;" data-options="formatter:ww4,validType:'dateShort'">
					</td>
					<th>报馆结束结束时间</th>
					<td>
						<input type="text" name="officeEnd" id="edit_officeEnd" class="easyui-datetimebox" required  style="width:100%;height:auto;" data-options="formatter:ww4,validType:'dateShort'" >
